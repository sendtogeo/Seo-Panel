...
if (!empty($menuInfo['item_list'])) {
	...
	?>
	<li>
		<a class="<?php echo $homeClass?>" href="<?php echo SP_WEBPATH?>/">
	...
	<?php } else {?>
		<li style="float: right; margin-right: 12px;">
			<a class="<?php echo $adminClass?>" href="<?php echo SP_WEBPATH?>/admin-panel.php">
	...
	<?php if (SP_HOSTED_VERSION) {?>
		<li style="float: right;">
			<a class="<?php echo $pricingClass?>" href="<?php echo SP_WEBPATH?>/register.php?sec=pricing"><?php echo $spText['common']['Pricing']?></a>
		</li>
	<?php }?>
<?php }?>