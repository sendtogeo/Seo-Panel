...
<table width="100%" border="0" cellspacing="0" cellpadding="0" class="search">
	<tr>
		...
		<td>
			<select name="search_engine" style='width:80px;'>
		...
		<td colspan="2"><a href="javascript:void(0);" onclick="scriptDoLoadPost('rank.php', 'search_form', 'content')" class="actionbut"><?php echo $spText['button']['Show Records']?></a></td>
	</tr>
</table>
</form>
